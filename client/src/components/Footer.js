    ...
    return (
        <div className="footer">
            ...
            <ul className="socials">
                ...
                <li><a className="youtube" href="#"><ion-icon name="logo-youtube"></ion-icon></a></li>
                <li><a className="instagram" href="#"><ion-icon name="logo-instagram"></ion-icon></a></li>
                <li><a className="linkedin" href="#"><ion-icon name="logo-linkedin"></ion-icon></a></li>
            </ul>
            <p className="footer-bottom-content">&copy;2023 Copyright Piece Of Case. All rights reserved.</p>
            </div>
        </div>
    );
}
